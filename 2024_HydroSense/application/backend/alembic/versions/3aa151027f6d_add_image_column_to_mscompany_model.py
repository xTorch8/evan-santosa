"""Add Image column to MsCompany model

Revision ID: 3aa151027f6d
Revises: aeba1cce667f
...
revision = '3aa151027f6d'
down_revision = 'aeba1cce667f'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    if not op.get_bind().dialect.has_table(op.get_bind(), 'MsCompany'):
        op.create_table(
            ...
            sa.Column('Image', sa.String(255), nullable=True),  # Add this line
            sa.PrimaryKeyConstraint('CompanyID')
        )
    else:
        op.add_column('MsCompany', sa.Column('Image', sa.String(255), nullable=True))  # Add this line
